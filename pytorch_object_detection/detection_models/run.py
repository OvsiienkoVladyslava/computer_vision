...
if __name__ == '__main__':
    ...
    parser.add_argument('--source-folder', type=str, default='.\\test_data',
                        help='path to folder with images, e.g. ".\\test_data" ')
    ...
    parser.add_argument('--save-folder-path', type=str, default='.\\test_results',
